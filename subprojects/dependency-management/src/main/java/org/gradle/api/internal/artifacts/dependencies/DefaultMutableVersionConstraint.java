...
public class DefaultMutableVersionConstraint extends AbstractVersionConstraint implements VersionConstraintInternal {
    ...
    private boolean appliesTransitively;
    ...
    public ImmutableVersionConstraint asImmutable() {
        return new DefaultImmutableVersionConstraint(preferredVersion, requiredVersion, strictVersion, rejectedVersions, branch, appliesTransitively);
    }
    ...
    @Override
    public void requireTransitive(String version) {
        require(version);
        appliesTransitively = true;
    }
