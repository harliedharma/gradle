...
| link:https://issuetracker.google.com/issues/112110217[Open Issue]
| N/A

| link:https://developer.android.com/jetpack/androidx/releases/lifecycle[Lifecycle]
| link:https://issuetracker.google.com/issues/129115778[Open Issue]
| N/A
...
| Litho
| link:https://github.com/facebook/litho/releases/tag/v0.25.0[0.25.0]
| N/A
